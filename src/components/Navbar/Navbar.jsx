                  ...
                  {mainNavLinks.map((link) => (
                    ...
                    >
                      <Link
                        title={link.title}
                        href={link.link}
                        className={`!p-[21px_12px] text-[14px] text-[#303234] uppercase border-b-2 border-transparent block group-hover:bg-[#f4f4ff] group-hover:text-primary group-hover:border-b-2 group-hover:border-primary ${router.pathname === link.link ? "text-primary border-b-2 !border-primary" : ""}`}
                      >
                        {link.title}{" "}
                        {link.isSubMenu ? (
