      ...
      <div className="container border-b-[3px] pb-[50px] border-b-gray-border">
        ...
        <div className="row items-center">
          ...
          <div className="col-md-6 md:text-left text-center">
            ...
            <Button href="" variant="fill" className="!p-[8px_20px] md:w-auto w-full">Read More</Button>
          </div>
        </div>
      </div>
    </section>
