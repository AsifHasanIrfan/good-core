      ...
      <div className="container">
        <div className="row text-center">
          <div className="col-md-12">
            ...
            <p className="sub-heading max-w-[950px] inline-block"> Money matters! Spend it wisely! We help build bespoke software products on budget and on time, all in a cost-effective manner. </p>
          </div>
        </div>
      </div>
    </section>
